...
Tuples are great because they allow each element in 
the array to be a known type of value.
...
// define our tuple
let ourTuple_2: [number, boolean, string];

// initialized incorrectly which throws an error
ourTuple_2 = [false, "Coding God was mistaken", 5];

/* Even though we have a boolean, string, and number the order 
matters in our tuple and will throw an error.
...
// define our tuple
let ourTuple_3: [number, boolean, string];
...
/* You see the new valueTuples only have strongly defined types 
...
will be a certain value type in this case a string and the 
second value a function.


Named Tuples
-------------
Named tuples allow us to provide context for our values at each 
index. */
